...
#Show tables for the p_mtools variables. We will use the values from the tables to manually create a data frame with which we can create a clustered bar chart.
...
database_test_p_mtools_df <- data.frame(
  ...
  "no" = c(405, 1455, 1985, 1175, 2115, 2225),
  "yes" = c(1855, 805, 275, 1085, 145, 35)
  )

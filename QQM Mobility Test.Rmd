...
# Assuming your breaks are based on your categories
breaks <- c(0, 1000, 5000, 10000, 15000, 25000, Inf)
kilometres <- c("0 or up to 1,000 km", "1,000 to 5,000 km", "5,000 to 10,000 km", "10,000 to 15,000 km", "15,000 to 25,000 km", "over 25,000 km")

# Your ggplot code
ggplot(data = database) +
  geom_col(mapping = aes(x = cut(kilometrage_per_car_1, breaks = breaks, labels = kilometres), fill = cut(kilometrage_per_car_1, breaks = breaks, labels = kilometres))) +
  scale_fill_manual(values = "skyblue") +
  labs(
    title = "Kilometrege of Car 1",
    x = "Kilometrage per year",
    y = "Frequency"
  ) +
  scale_x_discrete(breaks = breaks, labels = breaks)  # Adjusted labels to use breaks
